        ...
        <main ref="parallaxRef" class="relative z-10 flex flex-col items-center text-center">
            ...
            <div class="mb-16">
                <h1 ref="titleRef"
                    ...
                    COOKING<br>
                    <span
                        class="inline-block px-1 text-transparent bg-clip-text bg-linear-to-r from-slate-900 to-slate-500 dark:from-white dark:to-slate-500">
                        NOW
                    </span>
                </h1>
            ...
            <div class="mt-12 relative group cursor-pointer gsap-profile-img" @click="showRandomQuote">
                ...
                <!-- 頭像本體 -->
                <img src="/profile-icon.webp" alt="LOGO"
